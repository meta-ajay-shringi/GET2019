public class NQueen {
	 ...
	 * @return returns true if specified position is safe or false if specified
	 ...
	 * @param board board all elements of board are initially initialized to
	 * zero
	 * @param startRow of board.
	 * @param dimensionOfChessBoard of chess board.
	 * @return
	 */
