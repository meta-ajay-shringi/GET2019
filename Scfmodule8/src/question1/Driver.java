...
/*
 * This is main class where we chose choice addAnimal,
 * addZone, display, remove animal.
 */
public class Driver {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				case 1:
					z.addAnimal("mammals", "lion");
					break;
				case 2:
					
					z.addAnimal("reptiles", "crocodile");
					break;
					
				case 3:
					z.addAnimal("birds", "peacock");
					break;
